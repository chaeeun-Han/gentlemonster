        ...
        <div id="side_right">
            ...
            <div class="product-images">
                <div class="sub-images">
                    <!-- 이미지 리스트를 JSTL로 출력 -->
                    <c:forEach var="image" items="${mainImage}" varStatus="status">

                        <img src="${image}" alt="Sub Image ${status.index }">

                    </c:forEach>
                </div>
            </div>
            <br>
            <div style="height: 200px; text-align: center">${product.discription}</div>
            <br> <br>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingOne">
                        <button class="accordion-button collapsed" type="button"
                                ...
                                aria-controls="flush-collapseOne">제품 세부 정보
                        </button>
                    </h2>
