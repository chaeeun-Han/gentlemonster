		...
		<div class="d-flex justify-content-center">
			<ul class="nav justify-content-center">
				<li class="m-3 hv"><a
					...
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=view-all" id="item-view-all"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=1" id="item-1"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=2" id="item-2"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=3" id="item-3"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=4" id="item-4"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=5" id="item-5"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=6" id="item-6"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=7" id="item-7"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=8" id="item-8"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=9" id="item-9"> <img class="rounded-circle" alt="#"
				...
				<li class="m-3 hv"><a
					class="d-flex flex-column align-items-center text-center text-decoration-none text-reset"
					href="/gentlemonster/shop?bigCategoryId=1&smallCategoryId=10" id="item-10"> <img class="rounded-circle" alt="#"
